    ...
    case WM_COMMAND:
        {
            ...
            case IDM_EXIT:
                DestroyWindow(hWnd);
                break;
            case ID_STARTGAME_PVP:
                Application::Get().StartPVP();
                break;
            case ID_STARTGAME_PVE:
                Application::Get().StartPVE();
                break;
            default:
        ...
        break;
    case WM_LBUTTONDOWN:
        Application::Get().OnLButtonDown({GET_X_LPARAM(lParam), GET_Y_LPARAM(lParam)});
        break;

    case WM_KEYDOWN:
        Application::Get().OnKeyDown(static_cast<unsigned char>(wParam));
        break;
